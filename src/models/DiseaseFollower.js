...
// Indexes to keep feed + follow checks fast at scale.
diseaseFollowerSchema.index({ diseasePageSlug: 1, userId: 1 }, { unique: true });
diseaseFollowerSchema.index({ userId: 1, diseasePageSlug: 1 });
diseaseFollowerSchema.index({ diseasePageSlug: 1, followedAt: -1, _id: -1 });
